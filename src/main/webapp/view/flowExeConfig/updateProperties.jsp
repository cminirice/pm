...
<body class="input">
	...
	<div class="body">
		...
		<form id="validateForm" action="${base}/flowExeConfig/updateProperties" method="post">
			...
			<table class="inputTable">
				...
				<tr>
					<td style="text-align:center;border-left: 1px solid #dde9f5;border-right: 1px solid #dde9f5;">&nbsp;${comFlowPro.type}</td>
					...
					<td style="text-align:left;border-left: 1px solid #dde9f5;border-right: 1px solid #dde9f5;">&nbsp;<input type="text" value="${comFlowPro.value}" name="${comFlowPro.type}_${comFlowPro.name}"></input></td>
					...
					<c:if test="${comFlowPro.type==pro.type && comFlowPro.name==pro.name}">${pro.value}</c:if>
					</c:forEach>
					</td>
				</tr>
				</c:forEach>
