...
<body class="input">
	...
	<table class="inputTable">
		<tr>
		<th style="text-align:center" colspan="10">任务信息
		...
		<%	}
			...
			{
		 %>
		<tr title="双击显示任务详情" ondblclick="javascript:changeDisplay('<%=flowExeCode%>')"><td>流程编码：&nbsp;<%= flowExeCode%></td></tr>
		<tr style="display:none" id="<%=flowExeCode%>"><td>
			<table class="inputTable">
				<tr>
