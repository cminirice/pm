...
$().ready( function() {
	...
	if(actionMessages == ""){
		actionMessages = "您的操作已成功!";
	}
	$.dialog({type: "error", title: "操作提示", content: actionMessages, ok: "确定", okCallback: redirectUrl, cancelCallback: redirectUrl, width: 380, modal: true});
});
</script>
</head>
<body class="success">
