...
<script type="text/javascript">
	...
	function refreshConfig(){
		$.ajax({
			url: "${base}/container/refreshSpringconfig?containerID=${containerID}",
			data: "",
			type: "POST",
			dataType: "json",
			cache: false,
			success: function(data) {
				...
				if(data.status=='success'){
					setTimeout("window.location.href='${base}/container/viewSpringconfig?containerID=${containerID}'",1000);
				}
			}
		});
	}
