/***
 *	MINISHOP Admin Style
 *
 *	http://www.minishop.com
 *
 *	Copyright © 2010 minishop.com All Rights Reserved.
 **/
...
function setCookie(name, value) {
	...
	document.cookie = name + "=" + encodeURIComponent(value) + ((expires == null) ? "" : ("; expires=" + expires.toGMTString())) + ";path=${base}";
}
